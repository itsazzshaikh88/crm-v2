class Pagination {
    ...
    constructor(currentPageId, totalPagesId, pageOfPageId, recordsRangeId) {
        // Initialize elements
        this.pageOfPage = document.getElementById(pageOfPageId);
        this.recordsOfRecords = document.getElementById(recordsRangeId);
        this._currentPageInput = document.getElementById(currentPageId);
        this._totalPagesInput = document.getElementById(totalPagesId);
    ...
    displayRecordsRange = () => {
        ...
        this.recordsOfRecords.innerHTML = `<p class="mb-0">Showing records ${startRecord} to ${endRecord} out of ${this._totalRecords}</p>`;
    }
