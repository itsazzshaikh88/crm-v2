...
async function fetchCreditReport() {
    try {
        ...
        const url = `${APIUrl}/financial/credit_report`;
...
function showCredit(Credits, tbody) {
    let content = '';
...
function handlePagination(action) {
    ...
    fetchCreditReport(); // Fetch Request for the updated current page
}
