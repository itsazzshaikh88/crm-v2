    ...
    let l = `<tr>
                                <td colspan="${option?.colspan}" class="text-center text-danger">
                                    <div class="d-flex justify-content-center align-items-center flex-column">
                                        ...
                                        <h4 class="text-danger fw-normal">Financial data not found</h4>
                                    </div>
                                </td>
                            </tr>`;
...
const tableId = "financial-report";
...
async function fetchFinancials() {
    try {
        ...
        const url = `${APIUrl}/financial/list`;
        ...
        showFinancials(data.financials || [], tbody);
...
function showFinancials(Financials, tbody) {
    let content = '';
...
function handlePagination(action) {
    ...
    fetchFinancials(); // Fetch Request for the updated current page
}
