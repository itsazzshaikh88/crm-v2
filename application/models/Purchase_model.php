...
class Purchase_model extends App_Model
{
    ...
    public function get_req($type = 'list', $limit = 10, $currentPage = 1, $filters = [], $user = [])
    {
        ...
        $this->db->select("PO.PO_ID, PO.ORG_ID, PO.PO_STATUS, PO.PO_NUMBER, PO.REQUEST_ID,  PO.UUID, PO.COMPANY_NAME, PO.EMAIL_ADDRESS, 
    ...
    public function get_request_by_searchkey($searchkey, $searchvalue)
    {
        ...
        if ($searchkey) {
            ...
            $data['header'] = $this->db->select("PO.PO_ID, PO.ORG_ID, PO.PO_NUMBER, PO.UUID, PO.CLIENT_ID, PO.QUOTE_ID, PO.REQUEST_ID, PO.COMPANY_NAME, PO.EMAIL_ADDRESS, 
