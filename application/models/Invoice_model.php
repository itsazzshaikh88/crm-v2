...
class Invoice_model extends App_Model
{
    ...
    function get_invoicess($type = 'list', $limit = 10, $currentPage = 1, $filters = [], $search = null)
    {
    ...
    function get_invoices($type = 'list', $limit = 10, $currentPage = 1, $filters = [], $search = null)
    {
        $offset = get_limit_offset($currentPage, $limit);
    ...
    JOIN XXZP.XXEINV_INV_IMPLMNT imp 
        ...
        if (!empty($search)) {
            ...
            $searchConditions = [
                "LOWER(i.INVOICE_NUMBER) LIKE LOWER('%$search%')",
                "TO_CHAR(i.INVOICE_DATE, 'YYYY-MM-DD') LIKE '%$search%'",
                "LOWER(i.CUSTOMER_REGISTRATION_NAME) LIKE LOWER('%$search%')",
                "LOWER(i.INVOICE_TYPECODE) LIKE LOWER('%$search%')",
                "TO_CHAR(i.TOTAL_TAX_AMOUNT) LIKE '%$search%'",
                "TO_CHAR(i.PAYABLE_AMOUNT) LIKE '%$search%'"
            ];
