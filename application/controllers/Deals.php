...
class Deals extends App_Controller
{
    public function index()
    {
        ...
        $data['scripts'] = ['assets/js/pages/deals/list.js', 'assets/js/pages/deals/new-deal.js', 'assets/js/pages/activities/deal-activities.js', 'assets/js/pages/activities/email-activitiy.js'];
