...
<?php if (isset($options) && is_array($options)): ?>
    <?php if ($options['action'] === 'list'): ?>
        <a href="javascript:void(0)" onclick="openDealModal()" class="btn btn-success my-2">Create New Deal</a>
    <?php elseif ($options['action'] === 'form'): ?>
        <a href="leads" class="btn btn-success my-2">Created Deals</a>
    <?php else: ?>
        <a href="leads" class="btn border text-white my-2 mx-2">Created Deals</a>
        <a href="javascript:void(0)" onclick="openDealModal()" class="btn btn-success my-2 mx-2">Create New Deal</a>
    <?php endif; ?>
<?php endif; ?>
<!--end::Button-->