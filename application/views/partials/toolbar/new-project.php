...
<?php if (isset($options) && is_array($options)): ?>
    <?php if ($options['action'] === 'list'): ?>
        <a href="projects/new" class="btn btn-sm btn-success my-2">Add New Project</a>
    <?php elseif ($options['action'] === 'form'): ?>
        <a href="projects/" class="btn btn-sm btn-success my-2">Projects List </a>
    <?php else: ?>
        <a href="projects/" class="btn border text-white my-2 mx-2">Projects List </a>
        <a href="projects/new" class="btn btn-sm btn-success my-2 mx-2">Add New Project</a>
    <?php endif; ?>
<?php endif; ?>
<!--end::Button-->