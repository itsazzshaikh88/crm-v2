...
<?php if (isset($options) && is_array($options)): ?>
    <?php if ($options['action'] === 'list'): ?>
        <a href="projects/new" class="btn btn-success my-2">Create New Project</a>
    <?php elseif ($options['action'] === 'form'): ?>
        <a href="projects/list" class="btn btn-success my-2">Project List</a>
    <?php else: ?>
        <a href="projects/list" class="btn border text-white my-2 mx-2">Project List</a>
        <a href="projects/new" class="btn btn-success my-2 mx-2">Create New Project</a>
    <?php endif; ?>
<?php endif; ?>
<!--end::Button-->