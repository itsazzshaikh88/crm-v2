...
<?php if (isset($options) && is_array($options)): ?>
    <?php if ($options['action'] === 'list'): ?>
        <a href="javascript:void(0)" onclick="openMomModal()" class="btn btn-sm btn-success my-2">Add Minutes of Meetings</a>
    <?php elseif ($options['action'] === 'form'): ?>
        <a href="mom" class="btn btn-sm btn-success my-2">Minutes List</a>
    <?php else: ?>
        <a href="mom" class="btn border text-white my-2 mx-2">Minutes List</a>
        <a href="javascript:void(0)" onclick="openMomModal()" class="btn btn-sm btn-success my-2 mx-2">Add Minutes of Meetings</a>
    <?php endif; ?>
<?php endif; ?>
<!--end::Button-->