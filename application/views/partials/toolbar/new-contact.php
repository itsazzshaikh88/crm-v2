...
<?php if (isset($options) && is_array($options)): ?>
    <?php if ($options['action'] === 'list'): ?>
        <a href="contacts/new" class="btn btn-success my-2">Add New Contact</a>
    <?php elseif ($options['action'] === 'form'): ?>
        <a href="contacts/" class="btn btn-success my-2">Contact List </a>
    <?php else: ?>
        <a href="contacts/" class="btn border text-white my-2 mx-2">Contact List </a>
        <a href="contacts/new" class="btn btn-success my-2 mx-2">Add New Contact</a>
    <?php endif; ?>
<?php endif; ?>
<!--end::Button-->