                    ...
                    <div class="card-body p-9">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="row mb-7">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 fw-semibold text-muted">Request Number</label>
                                    <!--end::Label-->

                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <span class="fs-6 text-primary" id="lbl-REQUEST_NUMBER"></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="row mb-7">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 fw-semibold text-muted">Request Title</label>
                                    <!--end::Label-->

                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <span class="fs-6" id="lbl-REQUEST_TITLE"></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="row mb-7">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <span class="fs-6" id="lbl-BILLING_ADDRESS"></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
