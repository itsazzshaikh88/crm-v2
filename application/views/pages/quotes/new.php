            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 d-flex align-items-center justify-content-between mb-10">
                        <h1>
                            Quote For:
                            <a href="javascripot:void(0)" class="text-danger d-inline-flex gap-4 align-items-center justify-content-start alert-danger rounded fw-normal py-2 px-4">
                                <span class="text-decoration-underline">Choose Client</span>
                                <span class="bg-danger client-title-icon-box">
                                    <i class="las la-user-plus fs-2x text-light"></i>
                                </span>
                            </a>
                        </h1>
                        <h4 class="text-muted fw-normal">Quote Number: <span class="text-black">QUO-0000-00-00</span> </h4>
                    </div>
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="row">
                            <div class="col-md-3 d-flex align-items-center justify-content-start">
                                <label for="" class="fs-6 fw-bold">Job Title</label>
                            </div>
                            <div class="col-md-3">
                                <input type="text" class="form-control" placeholder="Enter request title">
                            </div>
                            <div class="col-md-3 d-flex align-items-center justify-content-end">
                                <label for="" class="fs-6 fw-bold">Sales Person</label>
                            </div>
                            <div class="col-md-3">
                                <input type="text" class="form-control" placeholder="Enter request title">
                            </div>
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="row">
                            <div class="col-md-3 d-flex align-items-center justify-content-start">
                                <label for="" class="fs-6 fw-bold">Employee Name</label>
                            </div>
                            <div class="col-md-3">
                                <input type="text" class="form-control" placeholder="Enter request title">
                            </div>
                ...
                <div class="my-10">
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="row mt-4">
                                <div class="col-md-3 d-flex align-items-center justify-content-start">
                                    <label for="" class="fs-6 fw-bold">Currency</label>
                                </div>
                                <div class="col-md-3">
                                    <input type="text" class="form-control">
                                </div>
                                <div class="col-md-3 d-flex align-items-center justify-content-end">
                                    <label for="" class="fs-6 fw-bold">Payment Term</label>
                                </div>
                                <div class="col-md-3">
                                    <input type="text" class="form-control">
                                </div>
