                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-12 mb-8">
                                        <h1 id="main-lbl-EMPLOYEE_NAME" class="border-bottom border-bottom-dashed border-secondary text-muted pb-4"></h1>
                                    </div>
                                </div>
                                <!--begin::Row-->
                                <div class="row mb-7">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 fw-semibold text-muted">Quote Number</label>
                                    <!--end::Label-->

                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <span class="fs-6 text-primary" id="lbl-QUOTE_NUMBER"></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="row mb-7">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <span class="fs-6" id="lbl-JOB_TITLE"></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="row mb-7">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <span class="fs-6" id="lbl-SALES_PERSON"></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="row mb-7">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <span class="fs-6" id="lbl-EMPLOYEE_NAME"></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
