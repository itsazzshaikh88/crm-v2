                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row g-1 mt-2 mb-1">
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        <select name="DIVISION" id="DIVISION" class="form-control border border-blue-100 text-gray-700 ">
                                            <option value="">Select Division</option>
                                            <option value="242">Non-Food</option>
                                            <option value="444">Food</option>
                                        </select>
                                        <label for="DIVISION" class="text-gray-600">Division <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-DIVISION"></p>
                                </div>
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        <select name="" id="" class="form-control border border-blue-100 text-gray-700 ">
                                            <option value="">Select Category</option>
                                        </select>
                                        <label for="LAST_NAME" class="text-gray-600">Categories <span class="text-danger">*</span></label>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        ...
                                        <label for="LAST_NAME" class="text-gray-600">Status <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                            </div>
                            <div class="row g-1 mb-1">
                                <div class="col-md-12">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">Product Name <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                            </div>
                            <div class="row g-1 mb-1">
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">Base Price <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">Currency <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        ...
                                        <label for="LAST_NAME" class="text-gray-600">Taxable <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                            </div>
                            <div class="row g-1 mb-1">
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">Tax Percentage <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">Vat Percentage <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">Discount in % <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                            </div>
                            <div class="row g-1 mb-1">
                                <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">Product Weight <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                                <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">Product Width <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                                <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">Product Length <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                                <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">Product Height <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                            </div>
                            <div class="row g-1 mb-1">
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">Minimum Quantity <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">Maximum Quantity <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">Available Quantity <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                            </div>
                            <div class="row g-1 mb-1">
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">SKU Number <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        <input type="text" placeholder="Enter Value" value="" class="form-control border border-blue-100 text-gray-700 " name="LAST_NAME" id="LAST_NAME">
                                        <label for="LAST_NAME" class="text-gray-600">Barcode Number <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                                <div class="col-md-4">
                                    <div class="d-flex form-floating">
                                        ...
                                        <label for="LAST_NAME" class="text-gray-600">Allow Backorders <span class="text-danger">*</span></label>
                                    </div>
                                    <p class="text-danger err-lbl mb-0 fs-8" id="lbl-LAST_NAME"></p>
                                </div>
                            </div>
