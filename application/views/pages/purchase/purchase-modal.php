                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row g-3 mb-2">
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex flex-column gap-1">
                                                <label for="CLIENT_NAME" class="text-gray-800 fw-bold">Contact Person<span class="text-danger">*</span></label>
                                                <input type="text" value="" readonly class="form-control form-control-sm border border-blue-100 text-gray-700" name="CLIENT_NAME" id="CLIENT_NAME">
                                            </div>
