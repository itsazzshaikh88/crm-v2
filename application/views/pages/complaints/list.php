		...
		<div class="row">
			...
			<div class="col">
				<a href="<?= base_url('complaints/list/total') ?>">
					<div class="card card-dashed min-w-175px my-3 p-4 d-flex align-items-center flex-row ">
						<img class="me-5" style="width: 60px;" src="<?= base_url('assets/images/customer-feedback.png') ?>" alt="Feedback">
						<div class="text-start ms-auto">
							<span style="font-size:x-large;font-weight:500" class="text-info d-flex flex-column text-start">Total</span>
			...
			<div class="col">
				<a href="<?= base_url('complaints/list/active') ?>">
					<div class="card card-dashed min-w-175px my-3 p-4 d-flex align-items-center flex-row ">
						<img class="me-5" style="width: 60px;" src="<?= base_url('assets/images/complaint.png') ?>" alt="Active">
						<div class="text-start ms-auto">
							<span style="font-size:x-large;font-weight:500" class="text-danger d-flex flex-column text-start">Active</span>
			...
			<div class="col">
				<a href="<?= base_url('complaints/list/closed') ?>">
					<div class="card card-dashed min-w-175px my-3 p-4 d-flex align-items-center flex-row ">
						<img class="me-5" style="width: 60px;" src="<?= base_url('assets/images/check.png') ?>" alt="Closed/Resolved">
						<div class="text-start ms-auto">
							<span style="font-size:x-large; font-weight:500" class="text-success d-flex flex-column text-start">Closed</span>
							<span class="text-success">
								<span class="fs-lg-2tx fw-bold d-flex justify-content-start">
			...
			<div class="col">
				<a href="<?= base_url('complaints/list/draft') ?>">
					<div class="card card-dashed min-w-175px my-3 p-4 d-flex align-items-center flex-row ">
						<img class="me-5" style="width: 60px;" src="<?= base_url('assets/images/to-do-list.png') ?>" alt="Closed/Resolved">
						<div class="text-start ms-auto">
							<span style="font-size:x-large;font-weight:500" class="text-primary d-flex flex-column text-start">Draft</span>
		...
		<div class="card">
			<div class="card-body">
				...
				<div class="table-responsive">
					<table class="table table-row-bordered gy-3" id="complaint-list">
						<thead>
