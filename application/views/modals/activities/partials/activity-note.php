        ...
        <div class="col-md-12 my-4">
            <div class="d-flex mb-1 gap-2">
                <div class="d-inline-flex form-floating w-50">
                    ...
                    <label for="custom-activity-modal-notes-lbl-LEAD_NUMBER" class="text-gray-600">Lead Number <span class="text-danger">*</span></label>
                </div>
                <div class="d-inline-flex form-floating w-50">
            ...
            <div class="my-3 text-end">
                <button class="btn btn-sm btn-primary" id="btn-add-activities">Add New Note</button>
            </div>
        </div>
    </div>
</form>